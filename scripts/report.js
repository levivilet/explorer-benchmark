...
export const renderFeasibility = (feasibility) => `<div class="failure"><p><strong>${feasibility.files.toLocaleString('en-US')}-file workload was infeasible on the benchmark host.</strong> ${escape(feasibility.reason)}</p><p>Available filesystem inodes: <code>${escape(feasibility.details.availableInodes)}</code>; required: <code>${escape(feasibility.details.requiredInodes)}</code>. No component measurement was attempted.</p></div>`
