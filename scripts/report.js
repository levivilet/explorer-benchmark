...
<p>${report.fixture.count.toLocaleString('en-US')} files. One open directory. ${report.protocol.repeats} planned fresh Chromium runs per implementation; infeasible workloads may have fewer attempts. Successful trees must render the first, middle and last files before measurement.</p>
